        ...
        try:
            ...
            for i in range(num_local):
                ...
                if weight is not None:
                    weight_q = apply_weight_quant(weight, strategy)
                ...
                running_var_c = running_var_c.to(dtype=strategy.compute_dtype)
                running_mean_c = running_mean_c.to(dtype=strategy.compute_dtype)
                weight_c = weight_c.to(dtype=strategy.compute_dtype)
                bias_c = bias_c.to(dtype=strategy.compute_dtype)
